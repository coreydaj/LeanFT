...
namespace AdVantage_AppModel
{
	...
	public class VantModel : AppModelBase
	{
		...
		public abstract class ListBoxNodeBase : AppModelNodeBase<HP.LFT.SDK.Web.IListBox, HP.LFT.SDK.Web.ListBoxDescription>, HP.LFT.SDK.Web.IListBox
		{
			...
			{
				ExecuteWithEvents(()=>Concrete.Select(items));
			}
			...
			{
				ExecuteWithEvents(()=>Concrete.Select(itemIndices));
			}
			public void Deselect(params HP.LFT.SDK.Web.IListItem[] items)
			{
				ExecuteWithEvents(()=>Concrete.Deselect(items));
			}
			...
			{
				ExecuteWithEvents(()=>Concrete.Deselect(itemIndices));
			}
